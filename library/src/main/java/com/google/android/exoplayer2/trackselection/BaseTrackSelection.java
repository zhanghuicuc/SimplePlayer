...
public abstract class BaseTrackSelection implements TrackSelection {
  ...
  public static final float DEFAULT_P1 = 0.6103f / 2 ;
  /**
  ...
  /**
   * Record selected bitrate, QoE and current buffer duration.
   */
  protected Map<String, String> selectionData = new HashMap<>();
  protected Float selectedQoE;
  /**
  ...
  public Float getQoEMedia(int index) {
    return group.getQoEMedia(getIndexInTrackGroup(index));
  }

  public Long getSegDutationsUs(int index) {
    return group.getSegDutationsUs(getIndexInTrackGroup(index));
  }
