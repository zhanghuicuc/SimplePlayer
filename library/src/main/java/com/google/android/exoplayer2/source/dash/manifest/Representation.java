...
public abstract class Representation {
  public static final String TAG = "Representation";
  /**
   ...
   * The format of the representation.
   */
  public Float QoeMedia;
  public final Float p1 = 0.6103f;
  public final Float p2 = 0.9437f;
  public final Float p3 = 0.5022f;
  public final Float p4 = 0.1748f;
  ...
  public abstract Float getQoeMedia();

  public abstract Long getSegDurationUs(int segmentIndex, long periodDurationUs);
  ...
  public static class SingleSegmentRepresentation extends Representation {
    ...
    @Override
    public Float getQoeMedia() {
      return Float.MIN_VALUE;
    }

    @Override
    public Long getSegDurationUs(int segmentIndex, long periodDurationUs) {
      return 0L;
    }
  ...
  public static class MultiSegmentRepresentation extends Representation
    ...
    @Override
    public Float getQoeMedia() {
      if (this.QoeMedia.equals(Float.MIN_VALUE)) {
        double r = format.bitrate;
        double ti = segmentBase.getSegmentTI(this);
        double si = segmentBase.getSegmentSI(this);
        double qoe = p1*Math.log(r) - p2*Math.log(ti) - p3*Math.log(si) + p4;
        this.QoeMedia = (float)qoe;
      }
      return this.QoeMedia;
    }

    @Override
    public Long getSegDurationUs(int segmentIndex, long periodDurationUs) {
      return getDurationUs(0, periodDurationUs);
    }
